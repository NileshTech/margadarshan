...
import 'package:margadarshan/database_models/inventory.dart';
import 'package:margadarshan/database_models/mat-inventory.dart';
import 'package:margadarshan/database_models/users.dart';
import 'package:margadarshan/helpers/auth.dart';
import 'package:margadarshan/page_models/excercise_model.dart';
import 'package:margadarshan/page_models/faq_model.dart';
...
class FirebaseDatabaseUtil {
  ...
  FirebaseDatabaseUtil._internal() {
    ...
    _faqRef = _inventoryRef.child(FaqModel.refName);
