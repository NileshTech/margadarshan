//It is plugin from pub.dev with name = "numberpicker:^---"
...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle = TextStyle(color: yipliWhite);
    TextStyle selectedStyle =
        themeData.textTheme.headline6.copyWith(color: yipliNewBlue);
    // TextStyle(color: yipliNewBlue, fontWeight: FontWeight.bold);
  ...
  Widget _decimalListView(ThemeData themeData) {
    ...
    int decimalItemCount =
        selectedIntValue == maxValue ? 4 : math.pow(10, decimalPlaces) + 4;
  ...
  bool _onDecimalNotification(Notification notification) {
    if (notification is ScrollNotification) {
      ...
      int decimalValueInTheMiddle = indexOfMiddleElement - 2;
