...
import 'package:margadarshan/database_models/adventure-gaming/adventure_gaming_data.dart';
import 'package:margadarshan/database_models/adventure-gaming/database-interface.dart';
import 'package:margadarshan/page_models/reward_model.dart';
import 'package:margadarshan/pages/player_rewards_page.dart';
import 'package:margadarshan/widgets/adventure_gaming_playerprofile_widget.dart';
import 'package:margadarshan/widgets/analytics/player_analytics_view.dart';
import 'package:margadarshan/widgets/timeline/adventureGameCardContent.dart';
...
class _PlayerProfileState extends State<PlayerProfilePage>
  ...
  Widget build(BuildContext context) {
    ...
    _playerProfileElements = ModalRoute.of(context).settings.arguments;
    ...
    if (_playerProfileElements == null) {
      ...
      return Consumer<CurrentPlayerModel>(builder: (BuildContext currentContext,
        ...
        return YipliPageFrame(
          ...
          child: buildProfilePageTile(
              context, playerModel, screenSize, currentPlayer,
      ...
      return ChangeNotifierProvider<PlayerModel>(create: (context) {
        ...
        var changeNotifierProxyProvider = buildProfilePageTile(
            context, playerModel, screenSize, currentPlayerModel);
        return YipliPageFrame(
            selectedIndex: 2,
  ...
  buildProfilePageTile(BuildContext context, PlayerModel playerModel,
      Size screenSize, CurrentPlayerModel currentPlayerModel,
    ...
    var _fitnessPointsInt = NumberFormat.compact()
        .format(playerModel?.activityStats?.iTotalFitnessPoints ?? 0);
  ...
  Widget _buildPlayerProfileDetails(
    ...
    return (playerModel?.activityStats?.iTotalFitnessPoints ?? 0) != 0 ||
            (playerModel?.activityStats?.iLastPlayedTimestamp ?? 0) != 0
        ? Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: SizedBox(
                  ...
                  child: PlayerAnalyticsView(playerIdFromArguments),
              ...
              Container(
                child: Padding(
                  ...
                  child: (playerModel?.activityStats?.gameStatistics?.length ??
                              0) >
                          0
...
Widget shareButton(
  ...
  var _fitnessPointsString = _fitnessPointsInt.toString();
  return FlatButton(
    onPressed: (playerModel?.activityStats?.iTotalFitnessPoints ?? 0) > 0
        ? () {
                              ...
                              children: <Widget>[
                                Expanded(
                                  ...
                                  child: YipliRewardPointsDisplay(
                                    ...
                                    coinPadding: 10.0,
                                    scoreString:
                                        widget?.gamesStats?.fitnessPoints ?? 0,
                                  ),
                                )),
                                Expanded(
                                  child: Center(
