...
class _RegisterMatPageState extends State<RegisterMatPage> {
  ...
  Widget build(BuildContext context) {
    UserOnBoardingFlows flowValue = ModalRoute.of(context).settings.arguments;
                ...
                children: <Widget>[
                  YipliUtils.buildBigButton(context,
                    ...
                    MatPageArguments matPageArgs =
                        new MatPageArguments(scannedValue, flowValue);
                    YipliUtils.goToAddMatScreen(matPageArgs);
                  }),
                  SizedBox(
                    height: 15,
                  ),
