...
import 'package:margadarshan/classes/playerDetails.dart';
import 'package:margadarshan/classes/userOnBoardingFlow.dart';
import 'package:margadarshan/helpers/constants.dart';
import 'package:margadarshan/helpers/utils.dart';
import 'package:margadarshan/internal_models/player_onboarding_state_model.dart';
import 'package:margadarshan/page_models/allplayers_model.dart';
import 'package:margadarshan/page_models/player_model.dart';
import 'package:margadarshan/page_models/user_model.dart';
import 'package:margadarshan/pages/games_page.dart';
import 'package:margadarshan/pages/yipli_page_frame.dart';
import 'package:margadarshan/widgets/player_list_widget.dart';
              ...
              child: Consumer2<AllPlayersModel, UserModel>(
                ...
                if (YipliUtils.appConnectionStatus ==
                  ...
                  return LayoutBuilder(builder: (context, boxConstraints) {
                    return ListView(
                      itemExtent: YipliUtils.getImageHeight(
                          context), //boxConstraints.maxHeight / 3.5,
