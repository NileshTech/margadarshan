...
import 'package:margadarshan/external_plgins/number_picker.dart';
...
class _PlayerOnBoardingState extends State<PlayerOnBoarding> {
  ...
  Widget build(BuildContext context) {
    ...
    PageViewModel pageViewModel4 = new PageViewModel(
                ...
                Theme(
                  data: theme.copyWith(
                      ...
                      textTheme: theme.textTheme.copyWith(
                        // headline: theme.textTheme.headline5.copyWith(color: yipliOrange), //other highlighted style
      ...
      image: Center(
        child: Image.asset(YipliAssets.yipliAddPlayerSliderImage_02,
            height: 400.0),
      ),
    );
