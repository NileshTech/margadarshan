...
import 'package:margadarshan/page_models/mat_model.dart';
import 'package:margadarshan/pages/games_page.dart';
import 'package:margadarshan/pages/register_mat.dart';
import 'package:margadarshan/pages/yipli_page_frame.dart';
import 'package:margadarshan/widgets/mat_list_item.dart';
    ...
    return FlatButton(
      onPressed: () async {
        if (YipliUtils.appConnectionStatus == AppConnectionStatus.CONNECTED) {
          Navigator.of(context).pushNamed(RegisterMatPage.routeName);
        } else {
