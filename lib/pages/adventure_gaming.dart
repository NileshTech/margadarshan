...
import 'package:margadarshan/database_models/adventure-gaming/class.dart';
import 'package:margadarshan/database_models/adventure-gaming/database-interface.dart';
import 'package:margadarshan/database_models/adventure-gaming/progress_stat.dart';
import 'package:margadarshan/page_models/FitnessCardsModel.dart';
...
class _AdventureGamingState extends State<AdventureGaming> {
  ...
  Widget buildClassesCard(
    ...
    if (classRef == null) {
      return buildAdventureGameCard(
          ...
          cardImagePath:
              adventureGamingData.world.storyline[chapterIndex].artworkImageUrl,
          androidUrl: adventureGamingData.world.androidUrl);
    }
  ...
  getStateForIndex({int currentChapterIndex, int currentPlayerIndex}) {
